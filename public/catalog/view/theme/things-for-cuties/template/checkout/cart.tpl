...
<div id="content"><?php echo $content_top; ?>
  ...
  <h1><span class="h1-top"><?php echo $heading_title; ?>
    <?php if ($weight) { ?>
    &nbsp;(<?php echo $weight; ?>)
    <?php } ?>
  </span></h1>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <div class="reload">
              <input type="image" src="catalog/view/theme/things-for-cuties/image/reload.png" alt="<?php echo $button_update; ?>" title="<?php echo $button_update; ?>" />
              &nbsp; &nbsp;<a href="<?php echo $product['remove']; ?>"><img src="catalog/view/theme/things-for-cuties/image/del.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a></div>
            </td>
          </tr>
          <tr><td colspan="6" class="emptyrow"></td></tr>
          <?php } ?>
          ...
          <tr>
            ...
            <td class="quantity"><input type="text" name="" value="1" size="1" disabled="disabled" />
              &nbsp;<a href="<?php echo $vouchers['remove']; ?>"><img src="catalog/view/theme/things-for-cuties/image/del.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a></td>
