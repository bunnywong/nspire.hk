...
$_['text_live'] = 'Live';
$_['text_sandbox'] = '測試模式';
$_['text_sort_order'] = '排序順序:';
$_['text_minimum_total'] = '最小訂單總額︰';
$_['text_all_geo_zones'] = 'All Geo Zones';
$_['text_status_enabled'] = '啟用';
$_['text_status_disabled'] = '停用';
$_['text_default_order_status'] = 'Pending:';
$_['text_ready_order_status'] = '準備發貨的狀態︰';
$_['text_canceled_order_status'] = '取消訂單的狀態︰';
$_['text_shipped_order_status'] = '發貨訂單狀態︰';
$_['text_last_cron_job_run'] = "Last cron job's run time:";
$_['text_allowed_ips'] = "IPs allowed";
$_['text_add'] = "Add";

$_['text_upload_success'] = '文件上傳成功';
...
// Errors
$_['error_permissions'] = '您沒有權限修改此模塊';
$_['error_empty_access_secret'] = '密鑰必填';
$_['error_empty_access_key'] = '訪問密鑰必填';
$_['error_empty_merchant_id'] = '商家ID必填';
$_['error_curreny'] = '你的店必須要安裝並啟用％的貨幣，';

$_['error_upload'] = '上傳失敗';

// Checkout button settings
$_['text_button_settings'] = 'Checkout按鈕設置';
$_['text_colour'] = '顏色:';
$_['text_orange'] = '橙色';
$_['text_tan'] = '棕褐色';
$_['text_white'] = '白色';
