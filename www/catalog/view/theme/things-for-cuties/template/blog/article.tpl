  ...
  <div class="information_content">
   ...
   <div id="blogArticle" itemscope itemtype="http://schema.org/Article">
      <div class="articleHeader">
         <h1 itemprop="headline"><span class="h1-top"><?php echo $title; ?></span></h1>
                ...
                $count = 1;
             	foreach ($prodRelateds as $prodRelated) {
                    ...
                    <?php if ($prodRelated['thumb']) { ?>
                    	<a class="image" href="<?php echo $prodRelated['href']; ?>" title="View more"> <img src="<?php echo $prodRelated['thumb']; ?>" alt="<?php echo $prodRelated['name']; ?>" />
                    	<?php if ($prodRelated['special']) { ?>
                    		<span class="new"><?php echo $sale; ?></span>
                    	<?php } ?>
                    	</a>
                    <?php } ?>
                    <h3 class="name"><a href="<?php echo $prodRelated['href']; ?>" title=""><?php echo $prodRelated['name']; ?></a></h3>
                    <?php if ($prodRelated['price']) { ?>
                    	<p class="wrap_price">
                    	<?php if (!$prodRelated['special']) { ?>
                    		<span class="price"><?php echo $prodRelated['price']; ?></span>
                    	<?php } else { ?>
    				...
    				<?php } ?>
    				<p class="submit">
              		<input type="button" value="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $prodRelated['product_id']; ?>');" class="button" />
            		</p>
					</div>
    				<?php } ?>
					</div>
