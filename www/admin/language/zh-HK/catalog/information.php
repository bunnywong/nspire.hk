...
$_['entry_store']       = '網店︰';
$_['entry_keyword']     = 'SEO關鍵詞︰<br /><span class="help">請確保關鍵詞的維一性。請不要使用空格，使用‘-’來替換空格</span>';
$_['entry_bottom']      = '頁面底部︰<br/><span class="help">在頁面底部顯示。</span>';
$_['entry_status']      = '文章狀態︰';
$_['entry_sort_order']  = '頁面排序︰';
$_['entry_layout']      = '布局覆蓋︰';

// Help
$_['help_keyword']      = '請確保關鍵詞在全站的唯一性。請不要使用空格，請使用‘-’來替換空格。';
...
$_['error_meta_title']  = 'Meta頁面標題長度必須在3至255字符之間！ ';
