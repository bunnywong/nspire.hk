...
$_['text_install']              = '安裝';
$_['text_uninstall']            = '卸載';
$_['lang_text_success']         = '成功︰設置已保存';
$_['lang_text_no_results']      = '沒有符合條件的結果';
$_['lang_checking_version']     = '檢查軟件版本';
$_['lang_btn_manage']           = '管理';
$_['lang_btn_retry']            = '重試';
$_['lang_btn_save']             = '保存';
$_['lang_btn_cancel']           = '取消';
$_['lang_btn_update']           = '更新';
$_['lang_btn_settings']         = '設置';
$_['lang_btn_patch']            = 'Patch';
$_['lang_btn_test']             = '測試鏈接';
$_['lang_latest']               = '您使用的是最新版本';
$_['lang_installed_version']    = '已安裝版本';
...
$_['lang_use_beta']             = '使用測試(Beta)版本';
$_['lang_use_beta_2']           = '不建議如此！';
$_['lang_test_conn']            = '測試 FTP 鏈接';
$_['lang_text_run_1']           = '執行更新';
$_['lang_text_run_2']           = '執行';
$_['lang_no']                   = '否';
$_['lang_yes']                  = '是';
$_['lang_language']             = 'API 接口接受語言';
$_['lang_getting_messages']     = '獲取 OpenBay Pro 信息';

// Column
$_['lang_column_name']          = '插件名稱';
$_['lang_column_status']        = '狀態';
$_['lang_column_action']        = '管理';

// Error
$_['error_permission']          = '警告︰您無權限修改 eBay 擴展功能！';
$_['lang_error_retry']          = '無法鏈接到 OpenBay 服務器。 ';
