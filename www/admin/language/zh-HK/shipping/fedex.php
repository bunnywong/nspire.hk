...
// Text
$_['text_shipping']                           = '貨運';
$_['text_success']                            = '成功︰ 您已修改聯邦快遞 (FEDEX) 貨運信息！';
...
$_['entry_key']                                = 'Key:';
$_['entry_password']                           = '密碼︰';
$_['entry_account']                            = '帳戶 ID︰<br /><span class="help">請輸入 FedEx 給您分配的帳號</span>';
$_['entry_meter']                              = 'Fedex Meter ID︰<br /><span class="help">請輸入聯邦快遞 (FEDEX)號碼表。</span>';
...
// Error
$_['error_permission']                         = '警告︰ 您沒有權限修改聯邦快遞 (FEDEX) 貨運信息！';
$_['error_key']                                = 'Key沒有填寫！';
